...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HTTPMatches) DeepCopyInto(out *HTTPMatches) {
	*out = *in
	if in.Headers != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HTTPMatches.
func (in *HTTPMatches) DeepCopy() *HTTPMatches {
	if in == nil {
		return nil
	}
	out := new(HTTPMatches)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ValueMatch.
